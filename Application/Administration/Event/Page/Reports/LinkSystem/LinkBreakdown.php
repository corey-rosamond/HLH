 ...
 * @version 1.2.0
 */
namespace App\Event\Page\Reports\LinkSystem;

/**
 * LinkBreakdown
 *
 * Breakdown of the performance of a given link
 */
class LinkBreakdown extends \App\Abstracts\Page
{
  /****************************************************/
  /*                  PAGE SETTINGS                   */
  /****************************************************/
  ...
  protected $_pageScripts = [["Reports.LinkSystem.LinkBreakdown.js", self::application]];
  /****************************************************/
  ...
  public function Body(array $parameters = array()){
    $datatable = $this->receptionist(self::oTypeDatatable,"LinkBreakdown");
    /** Set Our portlet title */
    $this->_dPortletConfiguration['title'] = "Link Breakdown";
    /** Set the portlet tools */
    $this->_dPortletConfiguration['tools'] = ['config'=>['data-onclick'=>'popup:Reports.LinkSystem.LinkBreakdown.Configuration']];
  ...
  {
    return '
    <div id="Reports.LinkSystem.LinkBreakdown.Configuration" class="modal fade">
