 ...
 * Sessions
 *
 * @package App\Event\Reports\Tracking
 * @version 1.2.0
 */
namespace App\Event\Page\Reports\Tracking;
...
class Sessions extends \App\Abstracts\Page
{
  ...
  public function Body(array $paramaters = array()){
    ...
    $this->setDocumentTitle('Tracking: Sessions');
    ...
    $this->_datatableTrackingMaster = \Framework\Core\Receptionist::datatable('TrackingMaster');
    /** Write the datatable to the body */
    $this->writeBody($this->_cDocument->portlet('box','green','fa fa-server','Tracking Sessions', '', $this->_datatableTrackingMaster->render(), [], []));
  }
}
