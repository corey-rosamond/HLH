...
Framework.Datatable = function( paramaters ){
  ...
  this.initalize = function( paramaters ){
    ...
    if( paramaters.loadLocation !== void 0 ){  this.loadLocation = paramaters.loadLocation; }
    /** If loadMethod was passed override the default */
    if( paramaters.loadMethod !== void 0 ){    this.laodMethod   = paramaters.loadMethod; }
    /** If loadData was passed override the default */
    if( paramaters.loadData !== void 0 ){      this.loadData     = paramaters.loadData; }
    /** If saveState was passed override the default */
    if( paramaters.saveState !== void 0 ){     this.saveState    = paramaters.saveState; }
    /** If responsive was passed override the default */
    if( paramaters.responsive !== void 0 ){    this.responsive   = paramaters.responsive; }
    /** If pageLength was passed override the default */
    if( paramaters.pageLength !== void 0 ){    this.pageLength   = paramaters.pageLength; }
    /** If menuLength was passed override the default */
    if( paramaters.menuLength !== void 0 ){    this.menuLength   = paramaters.menuLength; }
    /** If buttonClass was passed override the default */
    if( paramaters.buttonClass !== void 0 ){   this.buttonClass  = paramaters.buttonClass; }
  ...
  this.setDatatable = function( param ){
    ...
    if( param.id === void 0 && param.datatable === void 0 ){ return false; }
    /** If we have a buttonClass use it */
    if( param.buttonClass !== void 0 ){ this.buttonClass = param.buttonClass; }
